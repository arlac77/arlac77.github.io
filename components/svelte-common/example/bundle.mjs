		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(div1, "click", /*handleOuterClick*/ ctx[2])
				];
...
class Modal extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { close: 3 });
	}
}
...
class ActionButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { action: 2 });
	}
}
...
class DateTime extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { date: 0 });
	}
}
...
class Duration extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$5, create_fragment$5, safe_not_equal, { seconds: 0 });
	}
}
...
// (48:8) <div slot="content" class="dropdown-menu dropdown-menu-sw">
...
// (66:2) <ActionButton action={failingAction}>
...
// (70:4) <ul id="collapse-content" slot="content" in:fade out:fade>
...
function create_fragment$6(ctx) {
	...
	let if_block = /*modal*/ ctx[1] && create_if_block$3(ctx);
...
function instance$6($$self, $$props, $$invalidate) {
	...
	return [actionExecuted, modal, action, close];
}
